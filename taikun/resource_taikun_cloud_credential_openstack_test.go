		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccResourceTaikunCloudCredentialOpenStackConfig,
					cloudCredentialName,
					os.Getenv("OPENSTACK_USERNAME"),
					os.Getenv("OPENSTACK_PASSWORD"),
					os.Getenv("OPENSTACK_URL"),
					os.Getenv("OPENSTACK_DOMAIN"),
					os.Getenv("OPENSTACK_PROJECT"),
					os.Getenv("OPENSTACK_PUBLIC_NETWORK"),
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("taikun_cloud_credential_openstack.foo", "user", os.Getenv("OPENSTACK_USERNAME")),
					resource.TestCheckResourceAttr("taikun_cloud_credential_openstack.foo", "password", os.Getenv("OPENSTACK_PASSWORD")),
					resource.TestCheckResourceAttr("taikun_cloud_credential_openstack.foo", "url", os.Getenv("OPENSTACK_URL")),
					resource.TestCheckResourceAttr("taikun_cloud_credential_openstack.foo", "domain", os.Getenv("OPENSTACK_DOMAIN")),
					resource.TestCheckResourceAttr("taikun_cloud_credential_openstack.foo", "project_name", os.Getenv("OPENSTACK_PROJECT")),
					resource.TestCheckResourceAttr("taikun_cloud_credential_openstack.foo", "public_network_name", os.Getenv("OPENSTACK_PUBLIC_NETWORK")),
					resource.TestCheckResourceAttr("taikun_cloud_credential_openstack.foo", "region", os.Getenv("OPENSTACK_REGION")),
