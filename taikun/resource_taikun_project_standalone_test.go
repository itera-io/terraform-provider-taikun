		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckNoResourceAttr("taikun_project.foo", "vm.0.access_ip"),
...
func TestAccResourceTaikunProjectStandaloneAWSMinimalUpdateIP(t *testing.T) {
	cloudCredentialName := randomTestName()
	standaloneProfileName := randomTestName()
	projectName := shortRandomTestName()
...
func TestAccResourceTaikunProjectStandaloneAzureMinimalUpdateIP(t *testing.T) {
	cloudCredentialName := randomTestName()
	standaloneProfileName := randomTestName()
	projectName := shortRandomTestName()
