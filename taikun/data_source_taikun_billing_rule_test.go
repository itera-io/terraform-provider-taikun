		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.taikun_billing_rule.foo", "labels.#"),
					resource.TestCheckResourceAttrSet("data.taikun_billing_rule.foo", "labels.0.label"),
					resource.TestCheckResourceAttrSet("data.taikun_billing_rule.foo", "labels.0.value"),
					resource.TestCheckResourceAttrSet("data.taikun_billing_rule.foo", "labels.0.id"),
