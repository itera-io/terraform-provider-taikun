		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.0.name", "https"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.0.from_port", "443"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.0.to_port", "443"),
					...
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.1.name", "http"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.1.from_port", "80"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.1.to_port", "80"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.1.cidr", "0.0.0.0/0"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.1.ip_protocol", "TCP"),
				),
			},
			{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.0.cidr", "0.0.0.0/0"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.1.cidr", "0.0.0.0/0"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.2.cidr", "0.0.0.0/0"),
					resource.TestCheckResourceAttr("taikun_standalone_profile.foo", "security_group.3.cidr", "0.0.0.0/0"),
				),
			},
		},
	})
